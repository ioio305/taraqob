...
// Legacy UI types retained until the classic component library is removed.
export type SignalStatus =
  | 'draft' | 'pending_review' | 'published' | 'watch' | 'conditional'
  | 'active' | 'exit' | 'invalidated' | 'closed' | 'archived'
...
export type DecisionState = 'no_trade' | 'watch' | 'conditional' | 'active' | 'exit' | 'invalidated'
