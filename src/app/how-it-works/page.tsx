...
const ROLES: { id: Role; label: string; icon: string; desc: string }[] = [
  { id: 'user',  label: 'المستخدم',           icon: '👤', desc: 'يتابع التوصيات والتحليلات' },
  { id: 'admin', label: 'المدير / المشرف',    icon: '⚙️', desc: 'يدير المنصة والمستخدمين' },
]
        ...
        <section className="mb-14">
          ...
          {activeRole === 'admin' && (
            <div className="card p-6">
              ...
              <StepCard
                number="01"
                title="أدعُ المستخدمين وأدِر حساباتهم"
                description="من قسم 'المستخدمون' في لوحة الإدارة، يمكنك إضافة مستخدمين جدد، تعديل أدوارهم، تفعيل أو تعطيل حساباتهم، وإعادة تعيين كلمات المرور."
                tip="الدخول للمنصة بالدعوة فقط — لا يوجد تسجيل عام."
              />
              <StepCard
                number="02"
                title="راقب البيانات من الداشبورد"
                description="الداشبورد يعرض بيانات SPX وVIX والعقود الموصى بها في الوقت الفعلي. يتحدث كل 30 ثانية تلقائيًا."
                tip="استخدم 'معاينة كـ مستخدم' في الهيدر لترى ما يراه المستخدمون بدون تسجيل خروج."
              />
              <StepCard
                number="03"
                title="راجع سجل الأحداث"
                description="Audit Trail يُظهر كل إجراء تم على المنصة مع التوقيت والمنفذ — تعديل المستخدمين، إعادة تعيين كلمات المرور، وكل تغيير."
                warning="السجل لا يُحذف ولا يُعدَّل. كل إجراء موثق."
              />
            </div>
          )}
        </section>
