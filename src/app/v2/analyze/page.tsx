  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-6 space-y-5">
      ...
      <div className="bg-navy-900 border border-navy-700 rounded-xl p-4">
        <div className="text-sm font-medium text-gold-400 mb-3">أدخل رمز العقد أو Strike</div>
      ...
      {analysis && (
        <div className="space-y-4">
          ...
          {/* بيانات العقد */}
          <div className="bg-navy-900 border border-navy-700 rounded-xl p-4">
            <div className="text-xs text-surface-500 mb-3">بيانات العقد — مجلوبة تلقائياً من Tradier</div>
              ...
              {[
                ...
                <div key={row.label}>
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    {row.detail && <span className="text-xs text-surface-500 font-mono">{row.detail}</span>}
                  </div>
...
export default function AnalyzePage() {
  return (
    <div className="min-h-screen bg-navy-950 text-white" dir="rtl">
      ...
      <Suspense fallback={
        <div className="max-w-4xl mx-auto px-4 py-12 text-center text-surface-500">
          جاري التحميل...
        </div>
      }>
        <AnalyzeContent />
