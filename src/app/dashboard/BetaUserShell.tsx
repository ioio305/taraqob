  ...
  const Sidebar = (
    <aside className="flex flex-col h-full bg-white border-l border-surface-200">
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-1">
        ...
        <NavLink href="/dashboard/history" label="سجل التحليلات" icon={
          <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M12 8v4l3 3m6-3a9 9 0 1 1-18 0 9 9 0 0 1 18 0z"/></svg>
        } />
